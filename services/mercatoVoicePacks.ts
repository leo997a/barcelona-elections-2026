...
export const VOICE_PHRASES: VoicePhrase[] = [
  {
    ...
    language: 'en',
    text: 'Here we go',
    defaultAudioUrl: '/audio/voice-packs/mercato/here-we-go.wav',
  ...
  },
  {
    ...
    language: 'ar',
    text: 'الاتفاق يقترب',
    defaultAudioUrl: '/audio/voice-packs/mercato/agreement-close.wav',
    recommendedProfile: 'dealHeating',
    recommendedCue: 'TRANSFER_LOCK_DEEP',
    intensity: 'medium',
  },
  {
    id: 'transferApproaching',
    label: 'الانتقال يقترب',
    language: 'ar',
    text: 'الانتقال يقترب',
    defaultAudioUrl: '/audio/voice-packs/mercato/transfer-approaching.wav',
    recommendedProfile: 'dealHeating',
    recommendedCue: 'TRANSFER_LOCK_DEEP',
    intensity: 'medium',
  },
  {
    id: 'dealPercentagesCurrent',
    label: 'النسب الحالية للصفقات',
    language: 'ar',
    text: 'النسب الحالية للصفقات',
    defaultAudioUrl: '/audio/voice-packs/mercato/deal-percentages-current.wav',
    recommendedProfile: 'analysisLab',
    recommendedCue: 'DATA_SCAN_CLEAN',
    intensity: 'medium',
  },
  {
    ...
    language: 'ar',
    text: 'الأمور تحدث',
    defaultAudioUrl: '/audio/voice-packs/mercato/things-happening-now.wav',
  ...
  },
  {
    ...
    language: 'ar',
    text: 'الصفقة تشتعل',
    defaultAudioUrl: '/audio/voice-packs/mercato/mercato-heating-now.wav',
    recommendedProfile: 'dealHeating',
