...
const MERCATO_MUSIC_TRACKS = [
  { value: '/audio/music-packs/mercato-2026/before-the-kickoff-2026.mp3', label: 'Before the Kickoff 2026' },
  { value: '/audio/music-packs/mercato-2026/deadline-drumline-a.mp3', label: 'Deadline Drumline A' },
  { value: '/audio/music-packs/mercato-2026/deadline-drumline-b.mp3', label: 'Deadline Drumline B' },
  { value: '/audio/music-packs/mercato-2026/drumline-tension.mp3', label: 'Drumline Tension' },
  { value: '/audio/music-packs/mercato-2026/mercato-blitz-a.mp3', label: 'Mercato Blitz A' },
  { value: '/audio/music-packs/mercato-2026/mercato-blitz-b.mp3', label: 'Mercato Blitz B' },
  { value: '/audio/music-packs/mercato-2026/panic-to-victory.mp3', label: 'Panic to Victory' },
  { value: '/audio/music-packs/mercato-2026/eleventh-hour.mp3', label: 'The Eleventh Hour' },
  { value: '/audio/music-packs/mercato-2026/transfer-deadline-a.mp3', label: 'The Transfer Deadline A' },
  { value: '/audio/music-packs/mercato-2026/transfer-deadline-b.mp3', label: 'The Transfer Deadline B' },
];
...
const createMercatoMediaStoryTemplate = (input: MercatoMediaStoryTemplateInput): OverlayConfig => ({
  ...
  fields: [
    ...commonFields,
    { id: 'mercatoMediaVariant', label: 'Mercato media variant', type: 'hidden', value: input.variant },
    { id: 'headline', label: 'Main headline', type: 'text', value: input.headline },
    { id: 'subline', label: 'Supporting line', type: 'textarea', value: input.subline },
    { id: 'sourceLabel', label: 'Source label', type: 'text', value: input.source },
    { id: 'playerName', label: 'Player / target', type: 'text', value: input.playerName },
    { id: 'fromClub', label: 'From club', type: 'text', value: input.fromClub },
    { id: 'toClub', label: 'To club', type: 'text', value: input.toClub },
    { id: 'dealValue', label: 'Deal value', type: 'text', value: input.dealValue },
    { id: 'dealStatus', label: 'Deal status', type: 'text', value: input.dealStatus },
    { id: 'confidencePct', label: 'Confidence percent', type: 'range', value: input.confidencePct, min: 0, max: 100, step: 1 },
    { id: 'timerLabel', label: 'Clock / timer label', type: 'text', value: input.timerLabel },
    { id: 'storyItems', label: 'Story items JSON', type: 'textarea', value: JSON.stringify(input.storyItems, null, 2) },
    { id: 'mediaUrl', label: 'Media URL (image/video/local/public/direct)', type: 'text', value: input.mediaUrl || '' },
    { id: 'mediaAltUrl', label: 'Fallback media URL', type: 'text', value: '' },
    { id: 'mediaMode', label: 'Media mode', type: 'select', value: 'auto', options: [
      { value: 'auto', label: 'Auto detect' },
      { value: 'image', label: 'Force image' },
      { value: 'video', label: 'Force video' },
    ] },
    { id: 'mediaFit', label: 'Media fit', type: 'select', value: 'cover', options: [
      { value: 'cover', label: 'Cover' },
      { value: 'contain', label: 'Contain' },
    ] },
    { id: 'mediaMuted', label: 'Mute video media', type: 'boolean', value: true },
    { id: 'musicEnabled', label: 'Real music bed', type: 'boolean', value: true },
    { id: 'musicTrackUrl', label: 'Music track', type: 'select', value: input.musicTrackUrl, options: MERCATO_MUSIC_TRACKS },
    { id: 'musicVolume', label: 'Music volume', type: 'range', value: 0.16, min: 0, max: 0.45, step: 0.01 },
    { id: 'voiceEnabled', label: 'Real voice cue enabled', type: 'boolean', value: false },
    { id: 'voiceLibraryId', label: 'Real voice cue', type: 'select', value: input.voiceLibraryId, options: [
    ...
    { id: 'voiceTrigger', label: 'Voice trigger', type: 'select', value: 'manual_only', options: [
      { value: 'manual_only', label: 'Manual only' },
      { value: 'on_enter', label: 'On IN' },
      { value: 'on_update', label: 'On update' },
    ] },
    { id: 'voiceVolume', label: 'Voice volume', type: 'range', value: 0.9, min: 0, max: 1.5, step: 0.05 },
    { id: 'sfxEnabled', label: 'SFX enabled', type: 'boolean', value: false },
    { id: 'soundVolume', label: 'Sound volume', type: 'range', value: 0.7, min: 0, max: 3, step: 0.05 },
    { id: 'soundInStyle', label: 'IN SFX', type: 'select', value: 'LOWER_THIRD_WIPE', options: BROADCAST_SOUND_OPTIONS },
    { id: 'soundOutStyle', label: 'OUT SFX', type: 'select', value: 'SOFT_FADE', options: BROADCAST_SOUND_OPTIONS },
    { id: 'transitionIn', label: 'IN transition', type: 'select', value: 'GLASS_SWEEP', options: BROADCAST_TRANSITION_OPTIONS },
    { id: 'transitionOut', label: 'OUT transition', type: 'select', value: 'GLASS_SWEEP_OUT', options: BROADCAST_EXIT_OPTIONS },
    { id: 'audioSceneId', label: 'Audio scene', type: 'hidden', value: 'premium_subtle' },
    { id: 'scale', label: 'Template scale', type: 'range', value: 1.0, min: 0.5, max: 1.4, step: 0.05 },
    { id: 'positionY', label: 'Offset Y', type: 'range', value: 0, min: -300, max: 300, step: 5 },
    { id: 'positionX', label: 'Offset X', type: 'range', value: 0, min: -300, max: 300, step: 5 },
  ],
});
...
const MERCATO_MEDIA_STORY_TEMPLATES: OverlayConfig[] = [
  createMercatoMediaStoryTemplate({
    ...
    name: 'Mercato Media — Glass Briefing',
    icon: 'GLS',
    accent: '#22d3ee',
    description: 'Full-screen media briefing for image, video, local public paths, or direct online links with a real music bed.',
    headline: 'DEAL FILE OPEN',
    subline: 'A polished glass-room briefing for the first strong signal of a transfer story.',
    source: 'REO MERCATO DESK',
    playerName: 'Nico Williams',
    fromClub: 'Athletic Club',
    toClub: 'Barcelona',
    dealValue: 'EUR 58M',
    dealStatus: 'ADVANCED TALKS',
    confidencePct: 78,
    timerLabel: 'LIVE',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[4].value,
    voiceLibraryId: 'mercato_things_happening_now',
    storyItems: [
      { label: 'Signal', value: 'The player side is waiting for final club contact' },
      { label: 'Next step', value: 'Bonus structure and payment schedule' },
      { label: 'Watch', value: 'Premier League interest remains active' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-neon-map',
    variant: 'neon_negotiation_map',
    name: 'Mercato Media — Neon Negotiation Map',
    icon: 'MAP',
    accent: '#21f6aa',
    description: 'Route-map visual for source chains, club-to-club talks, and probability movement.',
    headline: 'NEGOTIATION MAP',
    subline: 'Track how a deal moves from first contact to the final desk.',
    source: 'SOURCE CHAIN',
    playerName: 'Joshua Kimmich',
    fromClub: 'Bayern',
    toClub: 'Barcelona',
    dealValue: 'Free + Bonus',
    dealStatus: 'MONITORING',
    confidencePct: 62,
    timerLabel: '48H',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[5].value,
    voiceLibraryId: 'mercato_deal_percentages_current',
    storyItems: [
      { label: 'A source', value: 'Sporting profile approved' },
      { label: 'B source', value: 'Salary still difficult', note: 'Needs outgoing movement' },
      { label: 'Market', value: 'No final bid yet' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-contract-scanner',
    variant: 'contract_scanner',
    name: 'Mercato Media — Contract Scanner',
    icon: 'DOC',
    accent: '#fbbf24',
    description: 'Contract-style scanner for clauses, salaries, release terms, and agreement details.',
    headline: 'PRIVATE CLAUSE',
    subline: 'A document scanner look for hidden clauses and contract details.',
    source: 'LEGAL DESK',
    playerName: 'Dani Olmo',
    fromClub: 'Leipzig',
    toClub: 'Barcelona',
    dealValue: 'EUR 60M',
    dealStatus: 'CLAUSE ACTIVE',
    confidencePct: 58,
    timerLabel: 'DOC',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[9].value,
    voiceLibraryId: 'mercato_transfer_approaching',
    storyItems: [
      { label: 'Clause', value: 'Release window still open' },
      { label: 'Contract', value: 'Five-year proposal discussed' },
      { label: 'Risk', value: 'Registration space must be solved' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-airport-tracker',
    variant: 'airport_tracker',
    name: 'Mercato Media — Airport Tracker',
    icon: 'AIR',
    accent: '#60a5fa',
    description: 'Transfer flight-board concept for travel, medical, arrivals, and final signature days.',
    headline: 'ARRIVAL TRACKER',
    subline: 'A live flight-board inspired template for travel and medical day.',
    source: 'TRAVEL WATCH',
    playerName: 'Joao Cancelo',
    fromClub: 'Manchester City',
    toClub: 'Barcelona',
    dealValue: 'Loan + Option',
    dealStatus: 'BOARDING',
    confidencePct: 72,
    timerLabel: '18:40',
    ...
    voiceLibraryId: 'mercato_transfer_approaching',
    storyItems: [
      { label: 'Departure', value: 'Private travel plan prepared' },
      { label: 'Arrival', value: 'Medical slot reserved' },
      { label: 'Final', value: 'Announcement assets pending' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-agent-voice-room',
    variant: 'agent_voice_room',
    name: 'Mercato Media — Agent Voice Room',
    icon: 'VOC',
    accent: '#ef4444',
    description: 'Source-call atmosphere with waveform, media background, and real audio cue support.',
    headline: 'VOICE NOTE LEAK',
    subline: 'Built for a direct audio-source story without forcing fake UI sounds.',
    source: 'PRIVATE SOURCE',
    playerName: 'Rafael Leao',
    fromClub: 'Milan',
    toClub: 'Barcelona',
    dealValue: 'High salary',
    dealStatus: 'SOURCE ONLINE',
    confidencePct: 51,
    timerLabel: 'REC',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[3].value,
    voiceLibraryId: 'mercato_things_happening_now',
    storyItems: [
      { label: 'Audio', value: 'The source says the player is open' },
      { label: 'Barrier', value: 'Salary structure is the hard wall' },
      { label: 'Club', value: 'No formal bid submitted yet' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-deal-heist-board',
    variant: 'deal_heist_board',
    name: 'Mercato Media — Deal Heist Board',
    icon: 'HST',
    accent: '#f43f5e',
    description: 'Investigation-board style for hijack attempts, rival bids, and hidden movements.',
    headline: 'HIJACK ALERT',
    subline: 'A high-tension board for when another club enters the race.',
    source: 'RIVAL WATCH',
    playerName: 'Bruno Guimaraes',
    fromClub: 'Newcastle',
    toClub: 'Man City',
    dealValue: 'EUR 100M',
    dealStatus: 'RIVAL BID',
    confidencePct: 66,
    timerLabel: 'ALERT',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[6].value,
    voiceLibraryId: 'mercato_heating_now',
    storyItems: [
      { label: 'Rival', value: 'A second club asked for conditions' },
      { label: 'Agent', value: 'The player side is listening' },
      { label: 'Decision', value: 'Next 24 hours decide the direction' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-social-storm',
    variant: 'social_storm',
    name: 'Mercato Media — Social Storm',
    icon: 'SOC',
    accent: '#ec4899',
    description: 'Modern social-reaction storm for viral posts, fan reaction, and news screenshots.',
    headline: 'SOCIAL STORM',
    subline: 'Use it with screenshots, player photos, or a video clip from a direct URL.',
    source: 'FAN SIGNALS',
    ...
    voiceLibraryId: 'mercato_deal_percentages_current',
    storyItems: [
      { label: 'Trend', value: 'Player post triggered huge reaction' },
      { label: 'Fans', value: 'Renewal expectation rising fast' },
      { label: 'Club', value: 'Official content team is ready' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-medical-greenlight',
    variant: 'medical_greenlight',
    name: 'Mercato Media — Medical Greenlight',
    icon: 'MED',
    accent: '#22c55e',
    description: 'Medical-pass visual for scans, fitness checks, and final approval stages.',
    headline: 'MEDICAL PASSED',
    subline: 'A clean scan-room concept for final medical and signature updates.',
    source: 'MEDICAL DESK',
    playerName: 'Marc Guehi',
    fromClub: 'Crystal Palace',
    toClub: 'Newcastle',
    dealValue: 'EUR 45M',
    dealStatus: 'GREENLIGHT',
    confidencePct: 88,
    timerLabel: 'PASS',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[2].value,
    voiceLibraryId: 'mercato_transfer_approaching',
    storyItems: [
      { label: 'Stage 1', value: 'Arrival completed' },
      { label: 'Stage 2', value: 'Medical checks passed' },
      { label: 'Stage 3', value: 'Signature and media pending' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-club-vault',
    variant: 'club_vault',
    name: 'Mercato Media — Club Vault',
    icon: 'VLT',
    accent: '#c8aa63',
    description: 'Finance/vault template for budget, valuation, add-ons, and release clauses.',
    headline: 'VAULT UNLOCK',
    subline: 'A money-room look for valuations, add-ons, and budget logic.',
    source: 'FINANCE ROOM',
    playerName: 'Mikel Merino',
    fromClub: 'Real Sociedad',
    toClub: 'Barcelona',
    dealValue: 'EUR 25M',
    dealStatus: 'BUDGET CHECK',
    confidencePct: 43,
    timerLabel: 'CAP',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[8].value,
    voiceLibraryId: 'mercato_deal_percentages_current',
    storyItems: [
      { label: 'Budget', value: 'Outgoing deals decide the final offer' },
      { label: 'Add-ons', value: 'Performance variables under discussion' },
      { label: 'Limit', value: 'Salary cap still tight' },
    ],
  }),
  createMercatoMediaStoryTemplate({
    id: 'template-mercato-media-deadline-war-room',
    variant: 'deadline_war_room',
    name: 'Mercato Media — Deadline War Room',
    icon: 'WAR',
    accent: '#fb923c',
    description: 'Deadline command room for final-hour chaos, live feeds, and urgent updates.',
    headline: 'FINAL HOUR',
    subline: 'A newsroom war-room built for the last minutes of deadline day.',
    source: 'DEADLINE DESK',
    playerName: 'Frenkie de Jong',
    fromClub: 'Barcelona',
    toClub: 'Liverpool',
    dealValue: 'EUR 75M',
    dealStatus: 'CLOCK RUNNING',
    confidencePct: 39,
    timerLabel: '00:42',
    musicTrackUrl: MERCATO_MUSIC_TRACKS[1].value,
    voiceLibraryId: 'mercato_heating_now',
    storyItems: [
      { label: 'Call 1', value: 'Agent waiting for final club signal' },
      { label: 'Call 2', value: 'Player side has not accepted yet' },
      { label: 'Clock', value: 'Paperwork must move before deadline' },
    ],
  }),
];
