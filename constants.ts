...
const INITIAL_TEMPLATE_DEFINITIONS: OverlayConfig[] = [
  ...
  },
  {
    ...
    slots: {},
    fields: [
      { id: 'designStyle', label: 'Design style', type: 'select', value: 'DEAL_BREAKER', options: ['DEAL_BREAKER', 'MARKET_COMMAND_CENTER', 'RUMOUR_RADAR', 'DONE_DEALS_WALL'] },
      ...
      { id: 'subheadline', label: 'Market subtitle', type: 'text', value: 'Live market update with confidence tracking' },
      { id: 'source',      label: 'المصدر',         type: 'text',  value: 'Reo Show Exclusive' },
      { id: 'marketItems', label: 'Market items JSON or player|from|to|value|confidence|status', type: 'textarea', value: '[{"player":"Nico Williams","from":"Athletic","to":"Barcelona","value":"58M EUR","confidence":78,"status":"Advanced talks"},{"player":"Joshua Kimmich","from":"Bayern","to":"Barcelona","value":"Free / Bonus","confidence":64,"status":"Monitoring"},{"player":"Joao Cancelo","from":"Man City","to":"Barcelona","value":"Loan + option","confidence":72,"status":"Expected"}]' },
      { id: 'dailyDeals', label: 'Done deals today', type: 'textarea', value: 'Here we go: young winger signs until 2030;Loan deal completed with buy option;Medical booked after verbal agreement' },
      { id: 'expectedDeals', label: 'Expected deals', type: 'textarea', value: 'Left wing priority moves to final shortlist;Defensive midfielder talks remain open;Full-back loan return being negotiated' },
      { id: 'latestNews', label: 'Latest market news', type: 'textarea', value: 'Club board approved the sporting profile and salary range;Agent meeting expected within 48 hours;Final decision depends on outgoing transfers' },
  ...
  },
  {
    ...
    name: 'Mercato Command Center',
    type: OverlayType.TRANSFER_NEWS,
    isVisible: false,
    templateIcon: 'MKT',
    templateAccent: '#00F5D4',
    templateGroup: 'MERCATO_PACKAGE',
    templateDescription: 'Full smart mercato package: deals done today, expected moves, latest news, and confidence metrics in one broadcast dashboard.',
    ...
    fields: [
      ...
      { id: 'headline', label: 'Main headline', type: 'text', value: 'MERCATO LIVE ROOM' },
      { id: 'subheadline', label: 'Subtitle', type: 'text', value: 'Smart transfer desk tracking today deals, expected moves and live market signals.' },
      ...
      { id: 'marketItems', label: 'Market items JSON or player|from|to|value|confidence|status', type: 'textarea', value: '[{"player":"Nico Williams","from":"Athletic","to":"Barcelona","value":"58M EUR","confidence":78,"status":"Advanced talks"},{"player":"Joshua Kimmich","from":"Bayern","to":"Barcelona","value":"Free / Bonus","confidence":64,"status":"Monitoring"},{"player":"Joao Cancelo","from":"Man City","to":"Barcelona","value":"Loan + option","confidence":72,"status":"Expected"},{"player":"Dani Olmo","from":"Leipzig","to":"Barcelona","value":"60M EUR","confidence":58,"status":"Complicated"}]' },
      { id: 'dailyDeals', label: 'Done deals today', type: 'textarea', value: 'Here we go: winger signs until 2030;Loan deal completed with buy option;Medical booked after verbal agreement' },
      { id: 'expectedDeals', label: 'Expected deals', type: 'textarea', value: 'Left wing priority moves to final shortlist;Defensive midfielder talks remain open;Full-back loan return being negotiated' },
      { id: 'latestNews', label: 'Latest news', type: 'textarea', value: 'Club board approved the sporting profile;Agent meeting expected within 48 hours;Outgoing transfers will decide the final budget' },
  ...
  },
  {
    ...
    name: 'Mercato Probability Radar',
    type: OverlayType.TRANSFER_NEWS,
    isVisible: false,
    templateIcon: 'RADR',
    templateAccent: '#7CFF6B',
    templateGroup: 'MERCATO_PACKAGE',
    templateDescription: 'A modern transfer radar showing predicted moves and each deal probability as a live scouting-board graphic.',
    ...
    fields: [
      ...
      { id: 'headline', label: 'Main headline', type: 'text', value: 'TRANSFER RADAR' },
      { id: 'playerName', label: 'Featured player', type: 'text', value: 'Nico Williams' },
      ...
      { id: 'marketItems', label: 'Predicted transfers JSON', type: 'textarea', value: '[{"player":"Nico Williams","from":"Athletic","to":"Barcelona","value":"58M EUR","confidence":78,"status":"Hot"},{"player":"Kimmich","from":"Bayern","to":"Barcelona","value":"Free","confidence":64,"status":"Watch"},{"player":"Cancelo","from":"City","to":"Barcelona","value":"Loan","confidence":72,"status":"Expected"},{"player":"Olmo","from":"Leipzig","to":"Barcelona","value":"60M EUR","confidence":58,"status":"Difficult"},{"player":"Merino","from":"Sociedad","to":"Barcelona","value":"25M EUR","confidence":43,"status":"Cold"}]' },
  ...
  },
  {
    ...
    name: 'Mercato Done Deals Wall',
    type: OverlayType.TRANSFER_NEWS,
    isVisible: false,
    templateIcon: 'DONE',
    templateAccent: '#19D37F',
    templateGroup: 'MERCATO_PACKAGE',
    templateDescription: 'A punchy wall for deals completed today with fee, source status, and club movement in a newsroom grid.',
