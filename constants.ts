...
const buildTransferTargetsTemplate = (
  ...
  fields: [
    ...
    { id: 'visualTheme', label: 'نمط التصميم', type: 'select', value: visualTheme, options: [
      { value: 'NEON_GLASS',      label: '🔵 Neon Glass — زجاج نيوني سيان' },
      { value: 'TACTICAL_DARK',   label: '⚫ Tactical Dark — تكتيكي داكن أحمر' },
      { value: 'LUXE_GOLD',       label: '🟡 Luxe Gold — ذهبي فاخر' },
      { value: 'CLEAN_BROADCAST', label: '🔷 Clean Broadcast — بث نظيف أزرق' },
      { value: 'GRADIENT_FIRE',   label: '🔴 Gradient Fire — تدرج ناري' },
      { value: 'CARBON_FIBER',    label: '⚫ Carbon Fiber — ألياف كربون رياضية' },
      { value: 'BARCA_HERITAGE',  label: '🔴 Barça Heritage — هوية برشلونة (Blaugrana)' },
      { value: 'EMERALD_FIELD',   label: '🟢 Emerald Field — أخضر الملعب' },
      { value: 'RETRO_ANALOG',    label: '📻 Retro Analog — تلفزيون قديم 80s' },
      { value: 'HOLOGRAM_PURPLE', label: '💜 Hologram — هولوغرام بنفسجي مستقبلي' },
    ] },
...
const buildBreakingHereWeGoTemplate = (
  ...
  fields: [
    ...
    { id: 'visualTheme', label: 'نمط التصميم', type: 'select', value: visualTheme, options: [
      { value: 'CINEMATIC_RED',  label: '🎬 Cinematic Red — سينمائي أحمر دراماتيكي' },
      { value: 'OFFICIAL_BLUE',  label: '🏢 Official Blue — رسمي أزرق احترافي' },
      { value: 'LUXE_GOLD',      label: '🥇 Luxe Gold — ذهبي فاخر للحدث الكبير' },
      { value: 'NEON_CYBER',     label: '🌐 Neon Cyber — نيون سايبر مستقبلي' },
      { value: 'MONO_BROADCAST', label: '⚪ Mono Broadcast — أحادي قناة BBC/Reuters' },
      { value: 'BLOOD_MOON',     label: '🩸 Blood Moon — قمر دامي درامي عميق' },
      { value: 'STORM_WARNING',  label: '⛈️ Storm Warning — تحذير عاصفة (أصفر/أسود)' },
      { value: 'BREAKING_GLASS', label: '🔨 Breaking Glass — زجاج محطم رقمي' },
      { value: 'CLASSIFIED',     label: '🔒 Classified — وثيقة سرية حمراء' },
      { value: 'GLOBAL_PULSE',   label: '🌍 Global Pulse — نبض عالمي خريطة' },
    ] },
