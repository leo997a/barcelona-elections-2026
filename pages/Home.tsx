    ...
    <div className="p-8 max-w-7xl mx-auto animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            <QuickLaunchCard 
                ...
                icon="👑"
                onClick={() => onCreate(OverlayType.LEADERBOARD)}
            />
            <QuickLaunchCard 
                title="التقرير الذكي" 
                ...
                icon="✨"
                onClick={() => onCreate(OverlayType.SMART_NEWS)}
            />
            <QuickLaunchCard 
                title="لوحة النتائج" 
                ...
                icon="⚽"
                onClick={() => onCreate(OverlayType.SCOREBOARD)}
            />
            <QuickLaunchCard 
                title="شريط الأخبار" 
                ...
                icon="📰"
                onClick={() => onCreate(OverlayType.TICKER)}
            />
             <QuickLaunchCard 
                title="Lower Third" 
                ...
                icon="👤"
                onClick={() => onCreate(OverlayType.LOWER_THIRD)}
            />
      </div>
    </div>
  );
