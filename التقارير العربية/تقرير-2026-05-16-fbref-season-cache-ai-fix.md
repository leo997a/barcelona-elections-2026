...
تم أيضًا اعتبار قيم مثل `غير متوفر` و`غير محدد` قيمًا ضعيفة في حقول الصور والشعارات، حتى لا يمنعها Gemini من الاستبدال برابط الكاش الحقيقي.
وفي حالة الوجهة مثل `Free agent` يتم ترك `toClubLogo` فارغًا بدل وضع نص غير صالح كأنه رابط صورة.
