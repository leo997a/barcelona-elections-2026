...
const normalizeScorer = (value: unknown, index: number): MondialLiveScorer | null => {
  ...
  return {
    ...
    assists: firstNumber(source.assists, source.Assists, source.goalAssist, source.goal_assist, source.assist, source.SubStatValue, source.subStatValue),
    shots: firstNumber(
      source.shots,
      source.Shots,
      source.totalShots,
    ...
    shotsOnTarget: firstNumber(
      source.shotsOnTarget,
      source.ShotsOnTarget,
      source.onTarget,
      source.OnTarget,
      source.shotsOnTargetTotal,
      source.ShotOnTarget,
      source.ontargetScoringAtt,
      source.OnTargetScoringAtt,
      source.shots_on_target,
      source.sot,
      source.SOT,
      source.onTargetShots,
      source.OnTargetShots,
      source.shotOnTarget,
    ),
    rating: firstNumber(source.rating, source.Rating, source.fotmobRating, source.FotMobRating, source.score, source.Score),
    keyPasses: firstNumber(
      source.keyPasses,
      source.KeyPasses,
      source.chancesCreated,
      source.ChancesCreated,
      source.bigChancesCreated,
      source.BigChancesCreated,
      source.chances,
      source.Chances,
      source.chanceCreated,
      source.ChanceCreated,
      source.createdChances,
      source.CreatedChances,
      source.xA,
