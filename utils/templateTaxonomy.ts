...
const TEMPLATE_TO_TAXONOMY: Record<string, { category: CategoryKey; subcategory: string; priority: number }> = {
  ...
  'template-mondial-territory-control':    { category: 'mondial', subcategory: 'mondial.stats', priority: 6 },
  'template-mondial-xg-shot-flow':         { category: 'mondial', subcategory: 'mondial.stats', priority: 7 },
  'template-mondial-live-momentum':        { category: 'mondial', subcategory: 'mondial.stats', priority: 8 },
  ...
  'template-mondial-match-announcement': { category: 'mondial', subcategory: 'mondial.results', priority: 4 },
  'template-mondial-full-time-broadcast': { category: 'mondial', subcategory: 'mondial.results', priority: 5 },
  'template-mondial-social-story':    { category: 'mondial', subcategory: 'mondial.results', priority: 6 },
  'template-mondial-knockout-bracket': { category: 'mondial', subcategory: 'mondial.results', priority: 7 },
  'template-mondial-group-table':     { category: 'mondial', subcategory: 'mondial.results', priority: 8 },
  'template-mondial-match-report':    { category: 'mondial', subcategory: 'mondial.results', priority: 9 },
  'template-mondial-ticker':          { category: 'mondial', subcategory: 'mondial.results', priority: 10 },
