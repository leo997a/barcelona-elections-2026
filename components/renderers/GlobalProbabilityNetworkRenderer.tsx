...
// ─── Mondial 2026 Color Palette for Global Probability Network ──────────────
const COLORS = {
  ink: '#03050a',
  panel: '#080c20',
  panel2: '#0f1535',
  ...
  text: '#F4F6F9',
  muted: '#94A3C8',
  cyan: '#004FFE',       // Electric Blue  (FIFA 2026)
  mint: '#00FFA9',       // Arena Green    (FIFA 2026)
  lime: '#FFE600',       // Gold / Yellow  (FIFA 2026)
  coral: '#FF2D55',      // Victory Red    (FIFA 2026)
  amber: '#FFA978',      // Rare Peach     (FIFA 2026)
};
...
const GlobalProbabilityNetworkRenderer: React.FC<GlobalProbabilityNetworkRendererProps> = ({ getField }) => {
  ...
  return (
    <div className={`gpn-root layout-${layout} stage-${transitionStage} ${revealNew ? 'is-updated' : 'is-old'} ${visibilityClasses}`} dir="rtl">
      <style>{`
        .gpn-root{--bg:${COLORS.ink};--panel:${COLORS.panel};--panel2:${COLORS.panel2};--line:${COLORS.line};--text:${COLORS.text};--muted:${COLORS.muted};width:100%;height:100%;padding:18px;background:radial-gradient(ellipse at 50% -20%,rgba(0,79,254,.35) 0%,rgba(8,12,32,.97) 60%,#03050a 100%);color:var(--text);font-family:'Tajawal','Outfit','Inter',sans-serif;overflow:hidden;display:flex;flex-direction:column;gap:12px;position:relative}
        .gpn-root:before{content:"";position:absolute;inset:0;pointer-events:none;opacity:.3;background-image:linear-gradient(rgba(255,255,255,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.02) 1px,transparent 1px);background-size:60px 60px}
        .gpn-root:after{content:"";position:absolute;z-index:8;pointer-events:none;top:0;bottom:0;left:-30px;width:10px;background:rgba(0,255,169,.9);box-shadow:0 0 22px 8px rgba(0,255,169,.28);opacity:0}.gpn-root.stage-reveal:after{animation:gpnSignalSweep 1.45s cubic-bezier(.16,.84,.44,1) both}
        .gpn-root>*{position:relative}.gpn-header{height:82px;flex:none;display:flex;align-items:center;justify-content:space-between;border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:12px 16px;background:rgba(6,12,30,.65);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);box-shadow:0 12px 32px rgba(0,0,0,.35);overflow:hidden}.gpn-header:before{content:"";position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(to right,#E8003D,#F5B800,#0052B4,#00A651)}
        ...
        .gpn-track{height:6px;border-radius:6px;background:rgba(255,255,255,.05);position:relative;overflow:visible}.gpn-track-old,.gpn-track-live{position:absolute;inset-block:0;left:0;border-radius:6px}.gpn-track-old{background:rgba(255,45,85,.35)}.gpn-track-live{transition:width 1.15s cubic-bezier(.16,.84,.44,1);box-shadow:0 0 14px currentColor}.gpn-track-marker{position:absolute;top:-3px;width:1px;height:12px;background:white}
        .gpn-tile{--deal-color:${COLORS.cyan};background:rgba(6,12,30,.45);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:11px;display:flex;flex-direction:column;gap:8px;overflow:hidden;position:relative;box-shadow:0 12px 30px rgba(0,0,0,.25),inset 0 0 20px rgba(255,255,255,.02)}.gpn-tile:before{content:"";position:absolute;inset:0 0 auto;height:3px;background:linear-gradient(90deg,transparent,var(--deal-color),${COLORS.lime},var(--deal-color),transparent);opacity:.85}.gpn-tile:after{content:attr(data-index);position:absolute;left:10px;top:4px;font:900 44px/1 'Orbitron',ui-monospace,monospace;color:rgba(255,255,255,.025)}.gpn-tile.is-featured{background:radial-gradient(circle at 75% 12%,color-mix(in srgb,var(--deal-color) 16%,transparent),transparent 42%),rgba(6,12,30,.55);border-color:color-mix(in srgb,var(--deal-color) 48%,transparent);box-shadow:0 18px 48px rgba(0,0,0,.34),0 0 34px color-mix(in srgb,var(--deal-color) 10%,transparent)}.gpn-featured-label{align-self:flex-start;border:1px solid color-mix(in srgb,var(--deal-color) 55%,transparent);border-radius:20px;padding:3px 10px;font-size:7px;font-weight:900;color:var(--deal-color);background:color-mix(in srgb,var(--deal-color) 8%,transparent);text-shadow:0 0 6px currentColor}.gpn-tile-top{display:flex;align-items:center;gap:11px;min-height:52px}.gpn-tile-name{min-width:0;flex:1}.gpn-tile-name span{font-size:7px;color:var(--deal-color);font-weight:900;text-shadow:0 0 8px currentColor}.gpn-tile-name strong{display:block;font-size:17px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gpn-tile-name small{display:block;font-size:8px;color:var(--muted)}.gpn-number{display:block;font:900 38px/.9 'Orbitron',ui-monospace,monospace;color:var(--deal-color);text-shadow:0 0 15px currentColor}.up{color:${COLORS.mint}}.down{color:${COLORS.coral}}.gpn-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px;direction:ltr}.gpn-metric{min-width:0;padding:5px 6px;border-left:1px solid rgba(255,255,255,.06);direction:rtl}.gpn-metric:last-child{border-left:0}.gpn-metric span{display:block;font-size:6px;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gpn-metric b{font:900 18px/1.15 'Orbitron',ui-monospace,monospace}.gpn-metric.previous b{color:#94A3C8}.gpn-metric.current .gpn-number{font-size:26px!important}.gpn-metric.movement b{font-size:16px}.gpn-tile footer{display:flex;justify-content:space-between;font-size:7px;color:var(--muted)}.gpn-tile footer b{color:var(--deal-color)}.gpn-tile.is-compact{padding:8px;gap:5px}.gpn-tile.is-compact .gpn-tile-name strong{font-size:12px}.gpn-tile.is-compact .gpn-tile-name small,.gpn-tile.is-compact footer,.gpn-tile.is-compact .gpn-route-club small,.gpn-tile.is-compact .gpn-featured-label{display:none}.gpn-tile.is-compact .gpn-route{padding:4px}.gpn-tile.is-compact .gpn-metric{padding:3px}.gpn-tile.is-compact .gpn-metric b{font-size:12px}.gpn-tile.is-compact .gpn-metric.current .gpn-number{font-size:16px!important}
        .gpn-lane{--deal-color:${COLORS.cyan};height:84px;display:grid;direction:ltr;grid-template-columns:210px 310px 1fr 68px;align-items:center;gap:14px;border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:6px 10px;margin-bottom:7px;background:rgba(6,12,30,.45);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}.gpn-lane-player{display:flex;align-items:center;gap:10px}.gpn-lane-player strong{display:block;font-size:13px}.gpn-lane-player small{display:block;font-size:8px;color:var(--muted)}.gpn-lane-track{height:5px;border-radius:5px;background:rgba(255,255,255,.05);position:relative}.gpn-lane-track .lane-fill{position:absolute;left:0;top:0;height:5px;border-radius:5px;background:var(--deal-color);transition:width 1.25s cubic-bezier(.16,.84,.44,1);box-shadow:0 0 12px var(--deal-color)}.gpn-lane-track .old-pin,.gpn-lane-track .live-pin{position:absolute;top:-12px;font:800 7px 'Orbitron',ui-monospace,monospace;transform:translateX(-50%)}.gpn-lane-track .old-pin{color:${COLORS.coral}}.gpn-lane-track .live-pin{color:var(--deal-color);top:8px}.gpn-lane-delta{font:900 17px 'Orbitron',ui-monospace,monospace;text-align:left}
